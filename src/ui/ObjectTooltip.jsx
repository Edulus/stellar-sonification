...
const styles = {
  ...
  alts: { fontSize: 9.5, letterSpacing: 0.6, color: "rgba(160,170,190,0.55)", marginTop: 2 },
  rule: { height: 1, background: "rgba(120,140,180,0.18)", margin: "7px 0 6px" },
  type: {
    fontSize: 8, letterSpacing: 1.4, textTransform: "uppercase",
    color: "rgba(150,175,220,0.7)", marginBottom: 5,
  },
  ...
  statLabel: {
    ...
    color: "rgba(150,160,185,0.5)", alignSelf: "center",
  },
  statValue: { fontSize: 10.5, color: "rgba(210,220,240,0.9)" },
  radec: {
    marginTop: 6, fontSize: 9, letterSpacing: 0.5,
    color: "rgba(150,160,185,0.45)", whiteSpace: "nowrap",
  },
  below: { color: "rgba(230,150,150,0.55)" },
};
